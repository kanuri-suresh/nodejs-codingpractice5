...
const objectSnaketoCamelCase = newObject => {
  return {
...
app.get('/states/', async (request, response) => {
  ...
  const statesResult = statesList.map(eachObject => {
    return objectSnaketoCamelCase(eachObject)
  })
...
app.get('/states/:stateId/', async (request, response) => {
  ...
  const stateResult = objectSnaketoCamelCase(newState)
...
app.get('/districts/:districtId/', async (request, response) => {
  ...
  const districtResult = districtSnaketoCamelCase(newDistrict)
